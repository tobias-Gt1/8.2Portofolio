  ...
  return (
    <section id="contact" ref={ref} className="py-24 sm:py-32">
      <div className="section-container">
        <div
          className={`animate-on-scroll mx-auto max-w-2xl text-center ${isVisible ? 'is-visible' : ''}`}
        >
          ...
          <a
            ...
            className="mt-10 inline-flex items-center gap-3 rounded-xl bg-gradient-to-r from-accent to-accent-pink px-10 py-4 text-base font-semibold text-white shadow-lg shadow-accent/25 transition-all hover:shadow-xl hover:shadow-accent/30 hover:brightness-110"
          >
            <MailIcon />
            {t('contact.cta')}
          </a>

          <p className="mt-10 text-sm text-text-muted">{t('contact.or')}</p>
          ...
          <div className="mt-6 flex items-center justify-center gap-4">
            {personalInfo.socials.map((social) => (
              <a
                ...
                className="flex h-12 w-12 items-center justify-center rounded-xl border border-border bg-bg-secondary text-text-muted transition-all hover:border-accent/50 hover:text-accent-light hover:shadow-lg hover:shadow-accent/5"
              >
